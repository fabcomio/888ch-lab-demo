              ...
              {issueOptions.map((issue) => {
                ...
                return (
                  <button
                    ...
                    className={`issue-button flex items-center gap-3 rounded border px-4 py-4 text-left font-semibold transition ${isSelected
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {urgencyOptions.map((option) => (
                  <button
                    ...
                    className={`rounded border px-4 py-3 text-left font-semibold transition ${intake.urgency === option
                      ? 'border-[#2dd4ff] bg-[#2dd4ff]/12 text-white'
              ...
              <div className="grid gap-3">
                {appointmentSlots.map((slot) => (
                  <button
                    ...
                    className={`flex items-center justify-between gap-4 rounded border px-4 py-3 text-left transition ${selectedSlot.time === slot.time
              ...
              {experienceFeatures.map((feature) => {
                ...
                return (
                  <button
                    ...
                    className={`group rounded border p-4 text-left transition ${active
